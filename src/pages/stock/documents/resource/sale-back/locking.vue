        ...
        <column-wrapper slot="row"
          ...
          <template v-for="(dict, index) in dataSet">
            <Column v-if="(dict.data=='handle')"
                    ...
                    v-bind:key="index">
              <a href="javascript:;"
                 @click="linkSaleBackDetail(scope.row)">查看详情</a>
            </Column>
            <Column v-else
                    :data="dict.data"
...
<script>
import { dataSet } from './locking.config.js'
import { queryLocking } from './request.js'
