      ...
      <div class="mdl-card__container">
        <Form ref="form"
          ...
          <Row>
            ...
            <Field title="入库仓库">
              <Select v-model="condition.stockinWarehouseCodes"
                      multiple
                      collapse-tags
            ...
            <Dates title="入库日期"
                   default
                   :start.sync="condition.stockinStartTime"
                   :end.sync="condition.stockinEndTime">
            </Dates>
          </Row>
          <div v-show="ifOption">
            <Row>
        ...
        <column-wrapper slot="row"
          ...
          <template v-for="(dict, index) in dataSet">
            <Column v-if="(dict.data=='billCode')"
                    ...
                    v-bind:key="index">
              <a href="javascript:;"
                 @click="triggleDetailStockin(scope.row)">{{scope.row[dict.data]}}</a>
            </Column>
